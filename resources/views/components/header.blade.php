    ...
    <a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
      ...
      <div class="navbar-inner">
        ...
        <ul id="topMenu" class="nav pull-right">
         ...
         <li class="">
          @if(Auth::user())
         <a href="{{ route('userlogout') }}" role="button"  style="padding-right:0"><span class="btn btn-large btn-success">Logout</span></a>
             
          @else
         <a href="{{ route('userlogin') }}" role="button"  style="padding-right:0"><span class="btn btn-large btn-success">Login</span></a>
